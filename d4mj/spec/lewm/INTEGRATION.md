...
- Shared execution does not enable LeWM control: its adapter rejects execution/imagination before touching the environment or heads. G1 was closed at the integration snapshot; it was subsequently implemented and passed by the [first research pair](../../../artifacts/experiments/20260906_lewm_paired/README.md). M4, H16, actor and renderer gates remain closed. Mechanical rollout support is not evidence of a learned horizon.
